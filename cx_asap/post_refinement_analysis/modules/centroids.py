...
class Centroids:
    ...
    def calculate_centroid(self, coords: dict, atom_names: list) -> "np.ndarray | None":
    ...
    def centroid_distance(
        self, coords: dict, atom_list_1: list, atom_list_2: list
    ) -> float:
        ...
        c1 = self.calculate_centroid(coords, atom_list_1)
        c2 = self.calculate_centroid(coords, atom_list_2)
    ...
    def find_centroid_distance(
        self, file_name: str, atom_list_1: list, atom_list_2: list
    ) -> float:
        ...
        return self.centroid_distance(coords, atom_list_1, atom_list_2)
    ...
    def analysis_centroid_distance(
        ...
        distance = self.find_centroid_distance(
            pathlib.Path(lst_name), atom_list_1, atom_list_2
        )
